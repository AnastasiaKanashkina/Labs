...
public class Lab1 {
	    ...
	    public static void main(String[] args) {
	    	...
	    	System.out.println("Введите координаты (x, y, z) Точки1");
	    	double point1X = getDouble();
	    	double point1Y = getDouble();
	    	double point1Z = getDouble();
	    	
	    	System.out.println("Введите координаты (x, y, z) Точки2");
	    	double point2X = getDouble();
	    	double point2Y = getDouble();
	    	double point2Z = getDouble();
	    	
	    	System.out.println("Введите координаты (x, y, z) Точки3");
	    	...
	    	if (point1.equals(point2) || point2.equals(point3) || point1.equals(point3)) {
	    		System.out.println("Две точки равны; площадь треугольника не может быть рассчитана.");
	    		return;
	    	}
	    	
	    	// Расчет и вывод площади треугольника пользователю
	    	else {
	    		String output = String.format("Плодащь треугольника равна %f", computeArea(point1, point2, point3));
